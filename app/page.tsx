...
export default function Home() {
  return <main>
    ...
    <footer className="footer"><div className="container footer-grid"><div><Logo /><p>Ayam segar dan produk ayam<br />untuk kebutuhan rumah dan usaha.</p></div><div><b>Explore</b><a href="#products">Products</a><a href="#why">Why CHIKEUN</a><a href="#business">For Business</a></div><div><b>Contact</b><a href={whatsapp}>0852 2052 1882</a><a href={catalog}>chikeun.katalogku.online</a></div></div><div className="container footer-bottom"><span>© 2026 CHIKEUN. All rights reserved.</span><span>Made fresh, made simple.</span></div></footer>
